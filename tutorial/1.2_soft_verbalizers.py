...
dataset = {}
dataset['train'] = AgnewsProcessor().get_train_examples("/nfs/users/weicheng/textCL/OpenPrompt/datasets/TextClassification/agnews/")
...
dataset['test'] = AgnewsProcessor().get_test_examples("/nfs/users/weicheng/textCL/OpenPrompt/datasets/TextClassification/agnews/")
