...
print(sys.path)
import soft_adaptive
from soft_adaptive import SoftTemplate2
import global_var
...
mytemplate = SoftTemplate2(model=plm, tokenizer=tokenizer, num_tokens=args.soft_token_num, initialize_from_vocab=args.init_from_vocab).from_file(f"/nfs/users/weicheng/textCL/OpenPrompt/scripts/{scriptsbase}/soft_template.txt", choice=args.template_id)
