...
import global_var
from soft_pos_ins_vec_adaptive import SoftTemplate_pos_ins_vec
...
mytemplate = SoftTemplate_pos_ins_vec(model=plm, tokenizer=tokenizer, num_tokens=args.soft_token_num, initialize_from_vocab=args.init_from_vocab, k=args.k).from_file(f"/nfs/users/weicheng/textCL/OpenPrompt/scripts/{scriptsbase}/soft_template.txt", choice=args.template_id)
